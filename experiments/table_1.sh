...
SOLV="random metis-homo-node metis-homo-comm metis-hete-comm ddm ddm_c1 ddm_c2 ddm_c3 ddm_c4" # metis-homogeneous-comm metis-heterogeneous-communication metis-heterogeneous-multilevel" # ddm"
