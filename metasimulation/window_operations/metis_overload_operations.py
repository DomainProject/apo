...
from src.metis import ddmmetis_init, metis_get_partitioning, metis_overload


class MetisOverloadOperations(WindowOperations):
    ...
    def on_window(self, cu_units_data, wct_ts, ending_simulation, traces, committed_idxs, time_window_size,
        ...
        metis_overload(num_actors, cus, task_forecast, capacity, comm_matrix)
        return min_vt
