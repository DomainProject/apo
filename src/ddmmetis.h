...
extern void metis_homogeneous_communication(idx_t total_actors, idx_t n_cus, real_t input_comm_cost_matrix[n_cus][n_cus], idx_t *input_forecast_capacity);
extern void metis_homogeneous_nodes(idx_t total_actors, idx_t cus, idx_t *tasks_forecast, real_t input_comm_cost_matrix[total_actors][total_actors]);
